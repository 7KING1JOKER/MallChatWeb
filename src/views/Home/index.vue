...
watch(() => videoStore.isPlaying, (newValue) => {
...
<template>
  <main class="home">
    ...
    <el-image-viewer
      v-if="imageStore.isShowing" :z-index="5000" :initial-index="0" :zoom-rate="1.1"
      :hide-on-click-modal="true" :url-list="[imageStore.previewUrl]" @close="imageStore.close()"
    />
    <LoginBox />
  </main>
</template>
